    ...
    <section ref={sectionRef} className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-parchment/50 pt-40">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 max-w-3xl">
        ...
        <div className="flex items-center gap-3 my-6">
          <div className="hero-rule-line w-12 h-px bg-sage-light origin-right" style={{ opacity: 0 }} />
          <svg viewBox="0 0 24 24" className="hero-diamond w-3 h-3 fill-sage" style={{ opacity: 0 }}>
            <path d="M12 2C8 8 4 10 2 12c2 2 6 4 10 10 4-6 8-8 10-10-2-2-6-4-10-10z" />
          </svg>
          <div className="hero-rule-line w-12 h-px bg-sage-light origin-left" style={{ opacity: 0 }} />
        </div>

        {/* Eyebrow */}
        <p className="hero-subtitle text-lg tracking-[0.18em] text-bark-light mb-6" style={{ opacity: 0 }}>
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-stretch sm:items-center w-full sm:w-auto">
          <a
            href="#works"
            className="hero-cta px-8 py-3.5 bg-rose text-cream text-xs tracking-[0.2em] uppercase rounded-full hover:bg-bark transition-all duration-300 hover:shadow-lg text-center"
            style={{ opacity: 0 }}
          >
            View My Work
          </a>
          <a
            ...
            className="hero-cta px-8 py-3.5 border border-bark/25 text-bark text-xs tracking-[0.2em] uppercase rounded-full hover:border-rose hover:text-rose transition-all duration-300 text-center"
            style={{ opacity: 0 }}
          >
            Book a Session
          </a>
      ...
      {/* Scroll indicator */}
      <div className="hero-scroll absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 animate-bounce" style={{ opacity: 0 }}>
